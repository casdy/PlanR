        ...
        <Card className="p-6 bg-gradient-to-br from-primary/5 to-card dark:from-primary/10 dark:to-card border-primary/10 overflow-hidden relative rounded-[2.5rem]">
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className={cn(
                        ...
                        {quotaExhausted ? '📦 PlanR Engine' : `⚡ ${remaining} PROMPTS LEFT`}
                    </div>
                </div>
            </div>
            ...
            {quotaExhausted && (
                <div className="flex items-start gap-3 p-3 rounded-2xl bg-orange-500/5 border border-orange-500/20 mb-4">
                    ...
                    <p className="text-xs text-muted-foreground font-medium">
                        AI quota reached for this session. Routines will be auto-generated by the custom **PlanR Engine** — still high-quality workouts!
            ...
            >
                ...
                {isGenerating
                    ...
                    : (quotaExhausted ? '+ Generate via PlanR Engine' : '+ Generate New Routine')
                }
            </Button>
